package com.example.windows.chatwith.userview;
...
import com.example.windows.chatwith.manager.AudioManager;
import com.example.windows.chatwith.manager.DialogManager;
import com.example.windows.chatwith.R;

/**
 * Created by Windows on 2018/6/27.
 * 录制音频按钮
 */
        ...
        if (mCurState != state) {
            ...
            switch (state) {
                case STATE_NORMAL:
                    ...
                    setText(R.string.BTN_RECORD_NORMAL);
                    break;
                case STATE_RECORDING:
                    setBackgroundResource(R.drawable.btn_recorder_recording);
                    setText(R.string.BTN_RECORD_RECORDING);
                ...
                case STATE_WANT_TO_CANCEL:
                    setBackgroundResource(R.drawable.btn_recorder_recording);
                    setText(R.string.BTN_RECORD_CANCEL);
